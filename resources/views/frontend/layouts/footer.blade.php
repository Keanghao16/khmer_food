                ...
                <div class="col-lg-4 col-sm-8 col-md-6">
                    <div class="fp__footer_content">
                        <a class="footer_logo" href="javascript:;">
                            <img src="{{ asset(config('settings.footer_logo')) }}" alt="Khmer-Food Resturant" class="img-fluid w-100">
                        </a>
                ...
                <div class="col-lg-2 col-sm-4 col-md-6 order-sm-4 order-lg-3">
                    <div class="fp__footer_content">
                        ...
                        <ul class="d-flex flex-wrap">
                            <li class="me-4"><a href="#"><i class="fab fa-facebook-f"></i></a></li>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="fp__footer_bottom_text d-flex flex-wrap justify-content-between">
                        <p>Copyright 2024 <b>Khmer Food Resturant</b> All Rights Reserved.</p>
                        <ul class="d-flex flex-wrap">
                            <li><a href="#">FAQs</a></li>
