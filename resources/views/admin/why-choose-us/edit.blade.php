    ...
    <section class="section">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h4>Update Why Choose Us card {{ $whyChooseUs->id }}</h4>
                ...
                <form action="{{ route('admin.why-choose-us.update', $whyChooseUs->id) }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" class="form-control" id="">
                            <option @selected($whyChooseUs->status === 1) value="1">Yes</option> {{-- in value field put true or false for postgres, 1 or 0 for mysql --}}
